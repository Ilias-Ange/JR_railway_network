...
int main() {
    int STATION_NUM=91, path_count=0;
    //std::cin >> STATION_NUM;
    MAP m(STATION_NUM);
    std::vector<std::string> STATION_NAME(STATION_NUM);

    // Read railmap.txt
    std::ifstream ifs_railmap("data/railmap.txt");
    ...
    std::ifstream ifs_station_num("data/station_num.txt");
    i=0;
...
*/
    ...
    find_all_path(m, 70, 83, &vtmp, STATION_NAME);
